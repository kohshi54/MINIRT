...
int	loop_handler(t_mlx_info *mlx_info)
{
	...
	t_object object5 = (t_object){&sphere5, NULL};
	t_sphere sphere4 = (t_sphere){vec_init(0, 0, 10), 1.0};
	t_object object4 = (t_object){&sphere4, &object5};
	t_sphere sphere3 = (t_sphere){vec_init(1, 0, 15), 1.0};
	t_object object3 = (t_object){&sphere3, &object4};
	t_sphere sphere2 = (t_sphere){vec_init(2, 0, 20), 1.0};
	t_object object2 = (t_object){&sphere2, &object3};
	t_sphere sphere1 = (t_sphere){vec_init(3, 0, 25), 1.0};
	t_object object1 = (t_object){&sphere1, &object2};

	// object5.next = &object1;
